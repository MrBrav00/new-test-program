...
from gadgets import *
from onnx_detection import *
from window_capture import WindowCapture
from bot_thread import Move
from switches_frame import SwitchesFrame
from dropdown_frame import DropdownFrame
from single_entry_frame import SingleEntryFrame
...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title("The Gatherer 2.0 - MacOS Edition")
        ...
        # UI Elements
        self.actions_frame = SwitchesFrame(self, name="Actions", text1="Display bot vision", text2="Gather resources", command_name1=update_vision_status, command_name2=update_bot_status)
        self.waiting_time_frame = SingleEntryFrame(self, header_name="EntryFrame1", name="Waiting Time", text="Delay (sec)", default=3.5)
        ...
        self.onnx_model_box = DropdownFrame(self, name="Select Model", text="Detection Model", default="rough_stone.onnx", options=self.models)
    ...
    def update_screenshot(self):
        ...
        if self.vision_status == "on":
            cv2.imshow("Bot Vision", self.frame)
            cv2.waitKey(1)
